...
test.beforeEach(async ({ page, baseURL }) => {
  ...
  await page.goto(baseURL + "/panel/asistencia-alumnos");
});
...
test("when date changes, absent students also do", async ({
  page,
  baseURL,
}) => {
  // ideally you compare the ids, not the lengths
  ...
  await page.waitForSelector(
    ".vc-pane-layout > .vc-pane > .vc-weeks > .vc-day:nth-child(33) > .vc-day-content"
  );
  await page.click(
    ".vc-pane-layout > .vc-pane > .vc-weeks > .vc-day:nth-child(33) > .vc-day-content"
  );
